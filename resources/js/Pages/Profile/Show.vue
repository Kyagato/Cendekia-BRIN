          ...
          <div class="flex flex-col sm:flex-row items-center sm:items-end justify-between gap-5 -mt-16 sm:-mt-20 mb-6">
            ...
            <div class="flex flex-col sm:flex-row items-center sm:items-end gap-5 text-center sm:text-left">
              <div class="relative shrink-0">
                ...
                <div
                  v-else
                  class="w-28 h-28 sm:w-32 sm:h-32 rounded-2xl border-4 border-white dark:border-slate-900 shadow-xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-extrabold text-4xl"
                >
                  {{ userInitials }}
                </div>
