...
<div class="space-y-6" x-data="{
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
            <!-- Tombol Tambah Bagian Baru (Warna Biru) -->
            <button @click="openCreateSectionModal()" 
                    class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-bold px-4 py-2.5 rounded-lg shadow-sm transition whitespace-nowrap shrink-0">
                    ...
                    <div class="px-6 py-4 bg-slate-100 dark:bg-slate-700 border-b border-slate-200 dark:border-slate-600 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                        <div class="flex items-center gap-3 flex-wrap">
                            ...
                            <h2 class="text-base font-bold text-slate-800 dark:text-slate-100 flex items-center gap-2">
                                ...
                                <span class="text-blue-600 dark:text-blue-400 font-extrabold text-lg">{{ $bagian }}</span>
                            </h2>
                        ...
                        <div class="flex items-center gap-2 shrink-0">
                            <!-- Edit Nama Bagian dengan Outline Kuning -->
                            <button @click="openEditSectionModal('{{ addslashes($bagian) }}')"
                                    class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-transparent border border-amber-500 dark:border-amber-400 text-amber-600 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-950/30 text-xs font-bold rounded-lg transition shadow-sm whitespace-nowrap"
                                    title="Edit nama bagian ini">
                                <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                                <span>Edit Bagian</span>
                            </button>

                            <!-- Tambah Judul Baru di Bagian Ini (Warna Biru) -->
                            <button @click="openCreateModal('{{ addslashes($bagian) }}')"
                                    class="inline-flex items-center justify-center px-3 py-1.5 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-xs font-bold rounded-lg transition shadow-sm whitespace-nowrap"
                            ...
                            @foreach($validQuestions as $faq)
                                <div class="p-6 hover:bg-slate-50 dark:hover:bg-slate-800 transition flex flex-col md:flex-row md:items-start justify-between gap-4">
                                    ...
                                    <div class="flex items-center gap-2 shrink-0 md:pt-1">
                                        <!-- Edit Pertanyaan dengan Outline Kuning -->
    ...
    @else
        <div class="bg-white dark:bg-slate-800 rounded-xl p-12 text-center border border-slate-200 dark:border-slate-700">
            ...
            <button @click="openCreateSectionModal()" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-xs font-bold px-4 py-2.5 rounded-lg transition shadow-sm">
                + Tambah Bagian Baru
            </button>
        </div>
    @endif
            ...
            <form action="{{ route('admin.faq.storeSection') }}" method="POST" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           required 
                           class="w-full px-4 py-2.5 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:ring-2 focus:ring-blue-600 focus:border-blue-600 text-sm font-medium">
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-slate-200 dark:border-slate-700">
                    ...
                    <button type="submit" class="px-5 py-2 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-sm font-bold rounded-lg shadow-sm transition">
                        Simpan Bagian
                    </button>
                </div>
            </form>
