...
<head>
    ...
    <title>Daftar — {{ config('app.name', 'MojoPedia') }}</title>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div class="relative z-10 flex-1 flex items-center justify-center py-8">
                        ...
                        <div class="hidden flex-col items-center justify-center text-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-slate-400 text-sm">Daftarkan akun MojoPedia Anda</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-col p-8 sm:p-10 lg:p-12">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-slate-400">Daftarkan diri Anda di MojoPedia</p>
                    </div>
