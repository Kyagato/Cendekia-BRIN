                ...
                @auth
                    <div class="relative py-2" x-data="{ userMenuOpen: false }" @mouseenter="userMenuOpen = true" @mouseleave="userMenuOpen = false">
                        ...
                        <div x-show="userMenuOpen" 
                            ...
                            @if(request()->routeIs('users.show') || request()->routeIs('profile.edit'))
                                <a href="{{ url('/') }}" class="flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700/60 transition">
                            ...
                            @else
                                <a href="{{ route('users.show', auth()->user()->id) }}" class="flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700/60 transition">
