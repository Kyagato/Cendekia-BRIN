        ...
        <div class="max-w-7xl mx-auto w-full flex items-center justify-between">
            <div class="flex items-center gap-8">
                ...
                @php
                    ...
                    $isKreator  = auth()->check() && auth()->user()->isMember();
                @endphp
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="relative py-2" x-data="{ userMenuOpen: false }" @mouseenter="userMenuOpen = true" @mouseleave="userMenuOpen = false">
                    ...
                    <div x-show="userMenuOpen"
                        ...
                        <a href="{{ route('users.show', auth()->user()->id) }}" class="flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition">
