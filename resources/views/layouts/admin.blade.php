        ...
        <div class="max-w-7xl mx-auto w-full flex items-center justify-between">
            <div class="flex items-center gap-8">
                ...
                <nav class="hidden md:flex items-center space-x-1">
                    ...
                    @php $moderatorRoles = ['Super Admin', 'Admin Pusat', 'Admin IPPD', 'Moderator']; @endphp
    ...
    <div class="flex-1 flex flex-col min-w-0">
        <main class="flex-1 p-4 sm:p-6 lg:p-8 bg-slate-50 dark:bg-slate-900">
            <div class="max-w-7xl mx-auto w-full">
                ...
                @if(session('success'))
                <div class="mb-6 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 text-green-700 dark:text-green-300 px-4 py-3 rounded-lg flex items-center gap-2">
                ...
                @if(session('error'))
                <div class="mb-6 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 text-red-700 dark:text-red-300 px-4 py-3 rounded-lg flex items-center gap-2">
