            ...
            <div class="p-8">
                <form action="{{ route('forum.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="judul" name="judul" value="{{ old('judul', isset($linkedKnowledge) ? 'Diskusi: ' . $linkedKnowledge->judul : '') }}" required placeholder="Contoh: Bagaimana cara mengimplementasikan arsitektur SPBE?" class="w-full px-4 py-3 rounded-lg border border-slate-300 focus:border-primary-500 focus:ring-primary-500 transition">
